...
describe "Acceso Usuario Página Car" do
  ...
  it "test_acceso _usuario _página _car" do
    page.open "/"
    ...
    page.click "link=Mis coches"
    !60.times{ break if ("MementoParking | Mis coches" == page.get_title rescue false); sleep 1 }
    ("MementoParking | Mis coches").should == page.get_title
    page.click "xpath=(//button[@type='button'])[2]"
