...
describe "Acceso Usuario Página Edit User" do
  ...
  it "test_acceso _usuario _página _edit _user" do
    page.open "/"
    ...
    !60.times{ break if ("MementoParking | Mis datos" == page.get_title rescue false); sleep 1 }
    ("MementoParking | Mis datos").should == page.get_title
    page.click "xpath=(//button[@type='button'])[2]"
    page.click "css=i.fa.fa-sign-out"
  end
end
