...
describe "Crear Usuario" do
  ...
  it "test_crear _usuario" do
    page.open "/"
    page.click "link=Registrarse"
    ...
    !60.times{ break if (page.is_element_present("id=user_password_confirmation") rescue false); sleep 1 }
    page.type "id=user_email", "usertest@gmail.com"
    page.type "id=user_password", "123456789"
    page.type "id=user_password_confirmation", "123456789"
    page.click "name=commit"
    page.wait_for_page_to_load "30000"
    !60.times{ break if (page.is_element_present("//div/div") rescue false); sleep 1 }
    ("x¡Bienvenido! Has sido autenticado correctamente.").should == page.get_text("//div/div")
